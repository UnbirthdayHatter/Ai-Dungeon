    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/45 backdrop-blur-md overflow-hidden pointer-events-none">
      <div className="pointer-events-auto flex w-full max-w-[110rem] flex-col items-center gap-6 px-4">
        ...
        <div className="relative h-[40rem] w-full overflow-hidden rounded-[2rem] border border-violet-400/16 bg-black/95 shadow-[0_0_90px_rgba(0,0,0,0.68)]">
          ...
          <div className="pointer-events-none absolute inset-[10px] z-[18] overflow-hidden rounded-[1.6rem] opacity-80">
            <img
              src="/assets/voidfire-warp.gif"
              alt=""
              className="h-full w-full object-cover"
            />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,0,0,0.08),rgba(0,0,0,0.28)_62%,rgba(0,0,0,0.46))]" />
          </div>
